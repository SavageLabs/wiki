...
> Right Click the "Raw" button then click "Save link as..." and make sure it is saved as config not config(1) otherwise it wont work. if the .json doesnt autmatically show on the end then dont add it otherwise it will be named config.json.json.
